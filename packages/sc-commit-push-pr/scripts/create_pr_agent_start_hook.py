#!/usr/bin/env python3
"""Preflight hook for the create-pr agent.

This hook runs before the create-pr agent starts and validates:
...
def main() -> int:
    """Run preflight checks for create-pr agent."""
    return run_preflight_check("create_pr_agent_start")

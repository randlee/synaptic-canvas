...
```bash
.claude/scripts/sc-term-launch.sh launch-claude-model haiku "<resolved_dir>" <TERM_ARG> <TAB_ARG> <IDENTITY_ARG> <CLAUDE_ARG_TAIL>
```
...
```bash
.claude/scripts/sc-term-launch.sh launch-claude-model haiku "<resolved_dir>" <TERM_ARG> <TAB_ARG> <IDENTITY_ARG> --tmux "<SESSION_NAME>" <CLAUDE_ARG_TAIL>
```
...
**Connect + Claude pane**:
```bash
.claude/scripts/sc-term-launch.sh attach-pane-claude-model "<SESSION_NAME>" haiku --cwd "<resolved_dir>" <TERM_ARG> <TAB_ARG> <IDENTITY_ARG> <CLAUDE_ARG_TAIL>
```

**New session (`next_name`)**:
```bash
.claude/scripts/sc-term-launch.sh launch-claude-model haiku "<resolved_dir>" <TERM_ARG> <TAB_ARG> <IDENTITY_ARG> --tmux "<next_name>" <CLAUDE_ARG_TAIL>
```

**Enter custom name** — ask for the session name in a follow-up message, then:
```bash
.claude/scripts/sc-term-launch.sh launch-claude-model haiku "<resolved_dir>" <TERM_ARG> <TAB_ARG> <IDENTITY_ARG> --tmux "<custom_name>" <CLAUDE_ARG_TAIL>
```

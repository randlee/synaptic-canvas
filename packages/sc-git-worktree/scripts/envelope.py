...
class ErrorCodes:
    ...
    # Stack layers (gh-stack): a layer is a branch cut from a pushed parent head
    STACK_LAYER_EXISTS = "STACK.LAYER_EXISTS"
    STACK_PARENT_NOT_PUSHED = "STACK.PARENT_NOT_PUSHED"
    STACK_PARENT_LANDED = "STACK.PARENT_LANDED"
    STACK_PARENT_OFF_TRUNK = "STACK.PARENT_OFF_TRUNK"
    STACK_ABOVE_INVALID = "STACK.ABOVE_INVALID"
    STACK_PARENT_HAS_CHILD = "STACK.PARENT_HAS_CHILD"
    STACK_HAS_CHILDREN = "STACK.HAS_CHILDREN"

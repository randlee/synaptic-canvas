...
def main() -> int:
            ...
            json.dumps(
                {
                    ...
                    "error": {
                        ...
                        "message": f"Package '{package}' may only be uninstalled locally",
                        "recoverable": False,
            ...
            json.dumps(
                {
                    ...
                    "error": {
                        ...
                        "recoverable": False,
                        "suggested_action": "Run inside a git repo for local uninstalls",
                    },
                }
            )
        )
    ...
    code, stdout, stderr = run_uninstall(sc_repo_path, package, dest)
    if code != 0:
        print(
            json.dumps(
                {
                    ...
                    "error": {
                        ...
                        "message": stderr.strip() or stdout.strip() or "Uninstall failed",
                        "recoverable": True,

...
- Execute: !`python3 .claude/scripts/sc_codex_task.py $ARGUMENTS`

## Response

Return only the JSON emitted by the execution step. Do not add commentary, code fences, or extra text.
